...
public class KeyboardStatusDetectorUtil {
    ...
    public KeyboardStatusDetectorUtil registerView(final View v) {
    ...
    public KeyboardStatusDetectorUtil setmVisibilityListener(KeyboardVisibilityListener listener) {
